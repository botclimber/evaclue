...
export const errorMessages = {
    ...
    CLAIMED_ALREADY: {status: 400, text: "This property was already claimed by you, if you don't see it in your profile page it might be still in the approving phase."},
