...
(function(html) {
    ...
    const cfg = {
        ...
        finalDate : 'September 1, 2023 00:00:00',
        // MailChimp URL
    ...
    * ---------------------------------------------------- */ 
    const ssMailChimpForm = function() {
        ...
        function hasError(field) {
            ...
            if (validity.valueMissing) return 'Por favor, insira um endereço de e-mail.';

            // If not the right type
            if (validity.typeMismatch) {
                if (field.type === 'email') return 'Por favor, insira um endereço de email válido.';
            }
            ...
            if (validity.patternMismatch) {
                ...
                return 'Por favor, corresponda ao formato solicitado.';
            }

            // If all else fails, return a generic catchall error
            return 'O valor inserido para este campo é inválido.';
